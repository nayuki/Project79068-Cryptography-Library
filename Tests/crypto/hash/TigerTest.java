...
public class TigerTest {
	...
	public void tiger() {
		...
		CryptoUtils.testWithAsciiMessage(Tiger.FUNCTION, msg3, "D981F8CB78201A950DCF3048751E441C517FCA1AA55A29F6");
		CryptoUtils.testWithAsciiMessage(Tiger.FUNCTION, msg4, "1714A472EEE57D30040412BFCC55032A0B11602FF37BEEE9");
		CryptoUtils.testWithAsciiMessage(Tiger.FUNCTION, msg5, "0F7BF9A19B9C58F2B7610DF7E84F0AC3A71C631E7B53F78E");
		CryptoUtils.testWithAsciiMessage(Tiger.FUNCTION, msg6, "8DCEA680A17583EE502BA38A3C368651890FFBCCDC49A8CC");
		CryptoUtils.testWithAsciiMessage(Tiger.FUNCTION, msg7, "1C14795529FD9F207A958F84C52F11E887FA0CABDFD91BFD");
		CryptoUtils.testWithAsciiMessage(Tiger.FUNCTION, msg8, "6DB0E2729CBEAD93D715C6A7D36302E9B3CEE0D2BC314B41");
	}
	...
	public void tiger2() {
		...
		CryptoUtils.testWithAsciiMessage(Tiger2.FUNCTION, msg3, "E29419A1B5FA259DE8005E7DE75078EA81A542EF2552462D");
		CryptoUtils.testWithAsciiMessage(Tiger2.FUNCTION, msg4, "F5B6B6A78C405C8547E91CD8624CB8BE83FC804A474488FD");
		CryptoUtils.testWithAsciiMessage(Tiger2.FUNCTION, msg5, "A6737F3997E8FBB63D20D2DF88F86376B5FE2D5CE36646A9");
		CryptoUtils.testWithAsciiMessage(Tiger2.FUNCTION, msg6, "EA9AB6228CEE7B51B77544FCA6066C8CBB5BBAE6319505CD");
		CryptoUtils.testWithAsciiMessage(Tiger2.FUNCTION, msg7, "D85278115329EBAA0EEC85ECDC5396FDA8AA3A5820942FFF");
