...
public class Channel<E>{
 ...
 class Putter extends Thread{
  E value;
  Putter(E v) throws Exception{System.out.println("Putter("+v+")");value=v;start();Thread.sleep(200);}
  public void run(){put(value);System.out.println("Put: "+value);}}

 class Getter extends Thread{
  Getter() throws Exception{System.out.println("Getter()");start();Thread.sleep(200);}
  public void run(){System.out.println("Get: "+get());}}
