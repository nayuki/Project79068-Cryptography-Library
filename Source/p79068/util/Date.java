 ...
 */
 public static int daysSinceEpoch(int year,int month,int day){
  ...
  if(d<Integer.MIN_VALUE||d>Integer.MAX_VALUE)throw new ArithmeticOverflowException();
  return (int)d;}
 ...
 */
 ...
 <p>Note: Epochs used in other systems, represented in this sytem:</p>
 <ul><li>1601-01-01 = day <code>-145731</code></li>
  <li>1900-01-01 = day <code>-36524</code></li>
  <li>1970-01-01 = day <code>-10957</code></li>
  <li>1980-01-01 = day <code>-7305</code></li></ul>
 */
 ...
 /** Returns the day of week of this date object. */
 public int getDayOfWeek(){
  return dayOfWeek;}

 /** Returns the number of days since the epoch, of this object. */
 ...
 /** Comparse this date with the specified date. */
 ...
 public Date add(int days){
  ...
  if(temp<Integer.MIN_VALUE||temp>Integer.MAX_VALUE)throw new ArithmeticOverflowException();
 ...
 /** Returns this date as a string: e.g., <code><var>yyyy</var>-<var>mm</var>-<var>dd</var></code>. This format is subject to change in the future. */
 public String toString(){
  return String.format("%04d-%02d-%02d",year,month,day);}


 private static int[] cumulativeDays={0,31,61,92,122,153,184,214,245,275,306,337};} // Cumulative days, 0 = March, ..., 11 = February of next year