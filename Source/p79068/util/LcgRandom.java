 ...
 */
 public LcgRandom(long a,long b,long m,long seed){
  if(m<32||m>64)throw new IllegalArgumentException();
  this.a=a;
  this.b=b;
  this.m=m;
  this.shift=m-32;
 ...
 public int randomInt(int n){
  ...
  if(IntegerMath.isPowerOf2(n))return (int)(((randomInt()&0xFFFFFFFFL)*n)>>>32); // Shift the wanted number of upper bits into the high region, then shift the high region down.
  else{ // Unbiased
   int random;
   int result;
   do{
