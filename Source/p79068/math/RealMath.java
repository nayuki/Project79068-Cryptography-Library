...
public class RealMath{
 ...
 public static float sinRevs(float x){
  ...
  double y=x*x;
  return (float)((((((
    3.9653034141171493607e1)*y
   -7.6564695440839330551e1)*y
   +8.1601632709834543134e1)*y
   -4.1341664669615459394e1)*y
   +6.2831851989975942410e0)*x);}
 ...
 public static float cosRevs(float x){
  ...
  double y=x*x;
  return (float)(sign*(((((
    5.6445734579155567248e1 )*y
   -8.5263204534087686108e1 )*y
   +6.4935380310507999466e1 )*y
   -1.9739179942871861928e1 )*y
   +9.9999996727011546714e-1));}
