...
final class Edonkey2000Hasher extends Hasher implements Zeroizable{
 ...
 public void zeroize(){
  ...
  oldmode=false;
  blockLength=0;
  if(hasher!=null&&hasher instanceof Zeroizable)((Zeroizable)hasher).zeroize();
  if(blockHasher instanceof Zeroizable)((Zeroizable)blockHasher).zeroize();
  hasher=null;
  blockHasher=null;
  hashFunction=null;}
 ...
 private void nextBlock(){
  if(blockLength==BLOCK_LENGTH){
   if(hasher==null)hasher=Md4.FUNCTION.newHasher();
