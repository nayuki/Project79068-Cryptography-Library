...
public final class Rijndael extends BlockCipher{
 ...
 public Rijndael(int keyLength,int blockLength){
  if(keyLength<4||keyLength%4!=0)throw new IllegalArgumentException("Invalid key length");
  if(blockLength<16||blockLength>32||blockLength%4!=0)throw new IllegalArgumentException("Invalid block length");
  this.keyLength=keyLength;
  this.blockLength=blockLength;}


 public Cipherer newCipherer(byte[] key){
  if(key.length!=keyLength)throw new IllegalArgumentException();
  if(blockLength==16)return new FastAesCipherer(this,key);
  else return new RijndaelCipherer(this,key);}
 ...
 public boolean equals(Object obj){
  if(!(obj instanceof Rijndael))return false;
