...
public final class HashCollection<E> extends Collection<E>{
 ...
 public int count(Object o){
  NullChecker.check(o);
  int index=o.hashCode()&mask;
  if(hashTable[index]!=null)return hashTable[index].count(o);
  else return 0;}
 ...
 public void add(E obj){
  ...
  if(hashTable[index]==null)hashTable[index]=new ArrayCollection<E>(1);
 ...
 public int removeAll(Object o){
  NullChecker.check(o);
  int index=o.hashCode()&mask;
  if(hashTable[index]!=null)return hashTable[index].removeAll(o);
  else return 0;}
 ...
 public void remove(CollectionView<E> coll){
  ...
  for(E obj:coll){
   int index=obj.hashCode()&mask;
   if(hashTable[index]!=null)hashTable[index].remove(obj);}}
